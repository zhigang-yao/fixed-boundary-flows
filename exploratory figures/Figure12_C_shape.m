%% Code for visualizing the C-shape data in Figure 12
%
...
%% Generate C-shape data
sigma = 0.02;
r = 1/pi; theta = pi/6:pi/800:pi/6*5;
x0 = [r*cos(theta);r*sin(theta)]; % noiseless data
